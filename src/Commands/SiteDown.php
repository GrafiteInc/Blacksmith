...
class SiteDown extends Command
{
     ...
     * @var string
     */
    protected $signature = 'blacksmith:site-down {--server=} {--site=}';
     ...
     * @var string
     */
    protected $description = 'Shut down a Forge site.';
    ...
    public function handle()
    {
        ...
        foreach ($serverIds as $serverId) {
            ...
            foreach ($siteConfigs as $config) {
                ...
                $forge->post("servers/$serverId/sites/$siteId/integrations/laravel-maintenance");
